 ...
 */
@Deprecated
public class FlowHeartLikeView extends RelativeLayout {
    ...
    public FlowHeartLikeView(Context context) {
        this(context, null);
    }

    public FlowHeartLikeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowHeartLikeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initParams() {
        ...
        mLikeDrawables.add(generateDrawable(R.drawable.heart_01));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_02));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_01));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_02));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_03));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_04));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_01));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_05));
        mLikeDrawables.add(generateDrawable(R.drawable.heart_06));
     ...
     */
    private static class CurveEvaluator implements TypeEvaluator<PointF> {
...
//                    + ((float) Math.pow(fraction, 2)) * endValue.y;
     ...
     */
    private static class CurveUpdateLister implements ValueAnimator.AnimatorUpdateListener {
